...
│   ├── planner/       ← asks GPT-4o what to do
...
**Job:** Look at all the market data and decide what the agent *should* do — using GPT-4o.
...
It's the name given to the reasoning engine in this project. It uses LangChain.js as the framework to call GPT-4o. LangChain handles prompt templating, retries, and output parsing.
...
observe()
  ...
  ├── discoverOpportunities()         → open prediction markets  ← currently mocked
...
GPT-4o's suggestions go through a filter. This phase cannot be bypassed:
...
11. openclaw.ts         GPT-4o responds: "ENTER_MARKET on market_002, 70% confidence"
...
4. packages/planner/ → write the prompt, test with GPT-4o mock first
