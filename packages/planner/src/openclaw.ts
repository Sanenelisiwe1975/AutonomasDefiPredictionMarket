...
export class OpenClawPlanner {
  ...
  constructor(config: PlannerConfig = {}) {
    this.config = {
      ...
      mock: config.mock ?? process.env["OPENAI_API_KEY"] === undefined,
    };
  ...
  private mockPlan(input: PlannerInput): ActionPlan {
    ...
    return {
      ...
      reasoning:
        "Mock plan generated (OPENAI_API_KEY not set or LLM unavailable). " +
        "Set OPENAI_API_KEY in .env to enable real LLM planning.",
