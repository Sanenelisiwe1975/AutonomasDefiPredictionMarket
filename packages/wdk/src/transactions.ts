 ...
 *
 * All onchain writes go through WalletAccountEvm.transfer() which:
 ...
 * @throws        If the transfer fails cos insufficient balance, fee cap exceeded
 */
 ...
 * @param account    - The WDK wallet account
 * @param to         - Recipient address
 * @param amountXaut - Amount in smallest XAU₮ unit (1 XAUT = 1 000000)
 */
