...
const COINGECKO_URL = "https://api.coingecko.com/api/v3/simple/price?ids=ethereum,tether,tether-gold&vs_currencies=usd";
 ...
 */
export async function fetchPrices(rpcUrl, network = "sepolia") {
    ...
    try {
        ...
        console.warn("[oracle] Chainlink fetch failed, falling back to CoinGecko:", err instanceof Error ? err.message : err);
 ...
 */
export function isUsdtDepegged(prices, thresholdPct = 0.5) {
